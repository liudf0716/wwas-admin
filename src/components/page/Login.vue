<template>
  <div class="login-wrap">
    ...
    <div class="footer">
      <div class="p" id="communityFooter">技术支持&nbsp;<i class="fa fa-comment"></i>&nbsp;: &nbsp;<a target="_blank" href="https://jq.qq.com/?_wv=1027&k=5StVwau">QQ群(424031785)群主</a></div>
    </div>
  </div>
</template>
          ...
          this.$axios
            ...
            .then(res => {
              if (res.data.ret_code == 0) {
                ...
                this.$axios
                  .post(global_.baseUrl + '/admin/info')
                  .then(userInfoRes => {
